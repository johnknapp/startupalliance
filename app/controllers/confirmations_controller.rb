class ConfirmationsController < Devise::ConfirmationsController
  ...
  def confirm
    ...
    resource.update(state: 'confirmed', role: 'user')
  ...
  private
    ...
    def permitted_params
      params.require(resource_name).permit(:first_name, :last_name, :username, :confirmation_token, :password, :password_confirmation)
    end
