...
EVENT_TYPE_TIP              = 'Lectures provide helpful information. AMAs let participants get their questions answered by an expert. Hangouts are for participant interaction.'
...
USER_TRAIT_TIP              = 'Only Personal Traits where you are rated appear to others.'
VIEWER_TRAIT_TIP            = 'This member has rated themselves for these Personal Traits.'
USER_SKILL_TIP              = 'Only Startup Skills where you are rated appear to others.'
