...
PROFESSIONAL_ROLE           = %w[Owner Marketing Sales Technical Operations Advisor Investor Other]
...
SUCCESS_ASSURANCE_TIP       = 'Members of each new Private Alliance and Company Workspace receive success assurance support to get the most from the platform.'
